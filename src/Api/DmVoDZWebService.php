...
class DmVoDZWebService extends \SoapClient
{
    ...
    public function __construct(array $options = array(), $wsdl = null)
    {
        ...
        if (!$wsdl) {
            $wsdl = '/Users/dennis/sites/CzechDataBox/Resources/dm_VoDZ.wsdl';
        }
        parent::__construct($wsdl, $options);
    }


    public function UploadAttachment(tUploadAttachmentInput $parameter): UploadAttachmentResponse
    {
        return $this->__soapCall('UploadAttachment', array($parameter));
    }

    public function DownloadAttachment(tDownloadAttachmentInput $parameter): tDownloadAttachmentOutput
    {
        return $this->__soapCall('DownloadAttachment', array($parameter));
    }


    public function CreateBigMessage(tBigMessageInput $parameter): tBigMessageOutput
    {
        return $this->__soapCall('CreateBigMessage', array($parameter));
    }


    public function AuthenticateBigMessage(tAuthenticateMessageInput $parameter): tAuthenticateMessageOutput
    {
        return $this->__soapCall('AuthenticateBigMessage', array($parameter));
    }


    public function SignedBigMessageDownload(tIDMessInput $parameter): tSignedMessDownOutput
    {
        return $this->__soapCall('SignedBigMessageDownload', array($parameter));
    }


    public function SignedSentBigMessageDownload(tIDMessInput $parameter): tSignedMessDownOutput
    {
        return $this->__soapCall('SignedSentBigMessageDownload', array($parameter));
    }


    public function BigMessageDownload(tIDMessInput $parameter): tMessDownOutput
    {
